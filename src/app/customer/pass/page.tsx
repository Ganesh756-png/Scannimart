...
export default function PassPage() {
    ...
    return (
        <div className="min-h-screen bg-green-50 flex flex-col items-center justify-center p-4">
            <div className="bg-white p-6 md:p-8 rounded-2xl shadow-xl w-full max-w-sm text-center border-4 border-green-500 relative">
                <div className="absolute -top-6 left-1/2 transform -translate-x-1/2 bg-green-500 text-white px-6 py-2 rounded-full font-bold shadow-md">
                    PAID & VERIFIED
                </div>

                <h1 className="text-2xl font-bold mt-8 text-gray-800">Exit Pass</h1>
                <p className="text-gray-500 text-sm mb-6">Show this to security at the exit gate.</p>
                ...
                <div className="text-left bg-gray-50 p-4 rounded-lg text-sm space-y-3">
                    ...
                    <div className="flex justify-between">
                        ...
                        <span className="font-bold text-green-700">₹{order.total_amount || order.totalAmount}</span>
                    </div>
                    <div className="flex justify-between">
