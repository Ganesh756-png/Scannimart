...
export default function StoreMapPage() {
    return (
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="max-w-4xl mx-auto bg-white p-4 md:p-8 rounded-2xl md:rounded-3xl shadow-xl border border-slate-200 relative overflow-hidden">

                {/* MAP CONTAINER */}
                <div className="overflow-x-auto pb-4 -mx-4 px-4 md:mx-0 md:px-0 md:overflow-visible md:pb-0">
                    <div className="min-w-[700px] md:min-w-0 grid grid-cols-4 gap-4 aspect-[4/3] md:aspect-video relative z-10 py-2">
                ...
                <svg className="absolute inset-0 w-full h-full pointer-events-none z-20 opacity-50 min-w-[700px] md:min-w-0" style={{ padding: '2rem' }}>
                    <path
